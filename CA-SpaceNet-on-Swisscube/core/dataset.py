...
class BOP_Dataset_train(Dataset):
    ...
    def getitem1(self, index):
        ...
        try:
            ...
            #### Load mask info. & Erase the satellite through morphological method.
            mask_path = img_path[:-14] + 'mask_visib/' + img_path[-10:-4] + '_000000.png'
            ...
            # cv2.imwrite('./masked/' + img_path[-10:-4] + '_.jpg', img)
            # cv2.imwrite('./masked/' + img_path[-10:-4] + '.jpg', masked)
        ...
        cv2.imwrite('./masked/' + img_path[-10:-4] + '__.jpg', merged_mask)
