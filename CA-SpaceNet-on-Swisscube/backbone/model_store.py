...
_model_sha1 = {name: (error, checksum, repo_release_tag, caption, paper, ds, img_size, scale, batch, rem) for
    ...
    ('alexnet', '1824', '8ada73bf8de14507a949c6a4a7e55d001a633bc5', 'v0.0.394', 'AlexNet', '1404.5997', 'in1k', 224, 0.875, 200, ''),  # noqa
    ...
    ('resnet10', '1436', '67d9a618e8670497386af806564f7ac1a4dbcd76', 'v0.0.248', 'ResNet-10', '1512.03385', 'in1k', 224, 0.875, 200, ''),  # noqa
    ...
    ('resnetbc14b', '1151', 'ca61209c4052228edad1fe7bb48ad6a19db509d1', 'v0.0.309', 'ResNet-BC-14b', '1512.03385', 'in1k', 224, 0.875, 200, ''),  # noqa
    ...
    ('resnet18', '0982', '0126861b4cd7f7b14196b1e01827da688f8bab6d', 'v0.0.153', 'ResNet-18', '1512.03385', 'in1k', 224, 0.875, 200, ''),  # noqa
    ('resnet26', '0854', '258347330aefca1c2387583680f812c9d6a8a66c', 'v0.0.305', 'ResNet-26', '1512.03385', 'in1k', 224, 0.875, 200, ''),  # noqa
    ...
    ('seresnet10', '1366', '6ec312230962e5f809e2dd77444a2a1bdfbb06f4', 'v0.0.354', 'SE-ResNet-10', '1709.01507', 'in1k', 224, 0.875, 200, ''),  # noqa
    ...
    ('ibn_densenet121', '0725', 'b90b0615e6ec5c9652e3e553e27851c8eaf01adf', 'v0.0.127', 'IBN-DenseNet-121', '1807.09441', 'in1k', 224, 0.875, 200, '[XingangPan/IBN-Net]'),  # noqa
    ...
    ('dla34', '0794', '04698d78b16f2d08e4396b5b0c9f46cb42542242', 'v0.0.202', 'DLA-34', '1707.06484', 'in1k', 224, 0.875, 200, '[ucbdrive/dla]'),  # noqa
    ...
    ('dla60x', '0598', '88547d3f81c4df711b15457cfcf37e2b703ed895', 'v0.0.202', 'DLA-X-60', '1707.06484', 'in1k', 224, 0.875, 200, '[ucbdrive/dla]'),  # noqa
...
def load_model(net,
    ...
    if ignore_extra:
        ...
        pretrained_dict = {k: v for k, v in pretrained_state.items() if k in model_dict}
