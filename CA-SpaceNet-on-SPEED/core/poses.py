...
class PoseAnnot(object):
    ...
    def __init__(self, bbox_3d, K, mask, class_ids, rotations, translations, width, height):
        self.keypoints_3d = bbox_3d  # 11 3D points
        self.K = K  # origin K
        self.mask = mask  # 1920*1920
        self.class_ids = class_ids  # [0]
        self.rotations = rotations  # R
        self.translations = translations  # T
        self.width = width  # 1920
        self.height = height  # 1920
    ...
    def transform(self, M, target_K, target_width, target_height):
        ...
        return PoseAnnot(self.keypoints_3d, target_K, new_masks, self.class_ids, new_rotations, new_translations, target_width, target_height)
